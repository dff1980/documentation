...
style id7 fill:#30BA78
  ...
  id1 --> id20
  id20 --> |Администрирование| id2(["RAN201 SUSE Rancher Operations 3 days#star;"])
  id20 --> |Развертывание| d30
  subgraph d30 ["SUSE Rancher Deployment eLearning Modules#star;"]
    id3([Deploy RKE])
...
id40["#star; - Доступна сертификация"]
```
